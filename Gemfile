...
gem "propshaft"
# Sprockets needed for ActiveAdmin's Sprockets-based JS/CSS manifests
gem "sprockets-rails"
...
# Password hashing — required by Devise
gem "bcrypt", "~> 3.1"
...
group :development, :test do
  ...
  # Interactive Ruby REPL (replaces irb in rails console)
  gem "pry-rails"
end
...
group :development do
  ...
  # Auto-annotate models, routes, and specs with schema info
  gem "annotate"
end
